...
using Applocation.Features.Schools.Queries;
...
public class SchoolsController : BaseApiController
{
    ...
    public async Task<IActionResult> DeleteSchoolAsync([FromRoute] int schoolId)
    {
        var response = await Sender.Send(new DeleteSchoolCommand
        {
            SchoolId = schoolId
        });
    ...
    public async Task<IActionResult> GetSchoolByIdAsync([FromRoute] int schoolId)
    {
    ...
    [ShouldHavePermission(SchoolAction.Read, SchoolFeature.Schools)]
    public async Task<IActionResult> GetSchoolByNameAsync([FromRoute] string name)
    {
        var response = await Sender.Send(new GetSchoolByNameQuery
        {
            Name = name
        });
